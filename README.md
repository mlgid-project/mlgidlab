...
> **Alpha (`v0.1.0a8`).** Pre-release for evaluation in the research
...
<video src="https://github.com/user-attachments/assets/c2c12162-6282-4c80-b22b-03f752072dc4" controls muted width="100%"></video>
...
pip install "mlgidlab[pipeline] @ git+https://github.com/mlgid-project/mlgidLAB@v0.1.0a8"
mlgidlab
```
